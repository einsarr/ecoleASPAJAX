...
namespace WebApplication1.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdU,Prenom,Nom,Identifiant,EmailU,TelephoneU,IdUser,Etat")] Utilisateur utilisateur, string Role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdU,Prenom,Nom,Identifiant,EmailU,TelephoneU,IdUser,Etat")] Utilisateur utilisateur)
        {
